        ...
        <div class="form" style="margin: 0 auto">
            <div class="form-row">
                <div class="form-group col-md-4">
                    <form action="/admin/showAllUsers" method="post">
                        <div class="text-center my-4">
                            <button type="submit" class="btn-green"><fmt:message key="allUsers"/></button>
                        </div>
                    </form>
                </div>
                <div class="form-group col-md-4">
                    <form action="/admin/getAllBooks" method="post">
                        <div class="text-center my-4">
                            <button type="submit" class="btn-green"><fmt:message key="books"/></button>
                        </div>
                    </form>
                </div>

                <div class="form-group col-md-4">
                    <form action="/admin/getLibrarianList" method="post">
                        <div class="text-center my-4">
                            <button type="submit" class="btn-green"><fmt:message key="librarians"/></button>
                        </div>
                    </form>
                </div>
            </div>
