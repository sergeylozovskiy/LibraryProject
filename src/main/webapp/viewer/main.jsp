            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <div class="text-center my-4">
                        <input type="button" class="btn-green" onclick="location.href='user.jsp';"
                               value="<fmt:message key="profile"/>"/>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <form action="/viewer/getBooks" method="post">
                        <div class="text-center my-4">
                ...
                <div class="form-group col-md-4">
                    <form action="/viewer/getOrders" method="post">
                        <div class="text-center my-4">
                            <input type="hidden" name="viewerId" title="" value="<%=user.getId()%>"/>
